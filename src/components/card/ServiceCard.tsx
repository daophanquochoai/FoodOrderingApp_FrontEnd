...
const ServiceCard: React.FC<serviceCartProps> = ({ image, hearder, descript }) => {
    return (
        <div
            ...
            style={{ minHeight: '250px', flexShrink: 0 }}
        >
            ...
            <div className="w-[65%] text-center mt-4">
                <h3 className="font-kanit text-lg font-medium">{hearder}</h3>
