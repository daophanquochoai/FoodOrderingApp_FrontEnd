...
import { GenericBanner, getBannerStyleByType } from '../../../components/banner';
...
const dataSubFake = [
    {
        type: 'banner_sub',
        variant: 'yellow-text',
        image: 'https://grillfood-demo.myshopify.com/cdn/shop/files/sub-banner-1.jpg?v=1746877062',
    ...
    },
    {
        type: 'banner_sub',
        variant: 'yellow-text',
        image: 'https://grillfood-demo.myshopify.com/cdn/shop/files/sub-banner-2.jpg?v=1746877062',
    ...
    },
    {
        type: 'banner_sub',
        variant: 'orange-text',
        image: 'https://grillfood-demo.myshopify.com/cdn/shop/files/sub-banner-3.jpg?v=1746877062',
        title: 'Corniche Taco',
        ...
        >
            {subBanners?.map((props, index) => (
                <div
                    ...
                    style={{ width: '40vw', maxHeight: '300px', flexShrink: 0 }}
                >
