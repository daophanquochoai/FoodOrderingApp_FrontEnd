        ...
        <div className="container">
            <div className="w-full block mx-auto ">
                <Row className="w-full">
                    <Col xs={24} md={10} xl={11} className="flex items-center justify-center">
                    ...
                    <Col xs={24} md={14} xl={13}>
                        <div className="p-3 xl:pt-10 xl:pl-20 lg:pl-14 md:pl-10 pl-3 pt-0 flex flex-col gap-3">
                            <h2 className="font-kanit text-[clamp(28px,3vw,35px)] font-medium leading-snug">
                                Amazing & Quality Food For Your Good Health
                            </h2>

                            <p className="text-gray-600 text-[clamp(12px,2vw,16px)] tracking-wide text-justify">
                                Welcome too restaurant where culinary excellence meets hospitality
                                    ...
                                    <Col xs={24} lg={12}>
                                        <div className="flex items-center justify-center gap-3">
                                            ...
                                            <div className="flex flex-col items-start justify-center">
                                                <h3 className="font-kanit text-[clamp(16px,2vw,20px)] font-medium">
                                                    Best Quality Food
                                                </h3>
                                                <p className="text-gray-600 text-[clamp(12px,2vw,16px)] tracking-wide text-justify">
