...
import { fetchDealOfWeek } from '@/store/action/admin/homepage/homepage.action';
import { selectDealOfWeek, selectDealOfWeekLoading } from '@/store/selector/admin/homepage/homepage.selector';
import { Spin } from 'antd';

const DealOfWeekHome = () => {
    const dispatch = useDispatch();
    const dealOfWeek = useSelector(selectDealOfWeek);
