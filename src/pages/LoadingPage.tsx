...
const LoadingPage: React.FC = () => {
    return (
        <div className="z-[1000] min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#fffbe6] to-[#ffe0b2] overflow-hidden fixed w-screen top-0 left-0 h-screen">
            <div>
            ...
            <p className="text-[#333] text-lg">Get your taste buds ready for some delicious food!</p>
            <style>{`
        @keyframes shake {
