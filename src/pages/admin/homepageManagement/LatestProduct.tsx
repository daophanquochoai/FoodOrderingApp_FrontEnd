...
const LatestProduct = () => {
    ...
    const handleAddToLatest = (record: any) => {
        dispatch(addProductToLatest(record));
    };

    const handleRemoveFromLatest = (record: any) => {
        ...
        },
        {
            ...
            render: (_, record) => (
                <Button
                    ...
                    onClick={() => handleAddToLatest(record)}
        ...
        },
        {
            ...
            render: (_, record) => (
                <Button
                    type="primary"
                    icon={<DeleteOutlined />}
                    onClick={() => handleRemoveFromLatest(record)}
    ...
    return (
        <Spin spinning={loading}>
            <div className="relative">
                ...
                <h2 className="text-xl pt-12 font-semibold mb-4">Latest Products</h2>
                <div className="grid grid-cols-[1fr_1.5fr] mt-6 gap-6">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold mb-2">Latest Products List</h3>
                        <Table
